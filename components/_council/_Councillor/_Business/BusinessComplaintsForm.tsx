...
export const BusinessComplaintsForm = ({ businesses }: { businesses: BusinessCompProps[] }) => {
  ...
  const processForm = async (data: HealthComplaintSchemaType) => {
    const res = await fetch("/api/business/complaints", {
      method: "POST",
      headers: {
              ...
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <SelectContent>
                      {businesses.map((item) => (
                        <SelectItem key={item.business_name} value={item.business_name}>
                          {item.business_name}
                        </SelectItem>
                      ))}
                    </SelectContent>
